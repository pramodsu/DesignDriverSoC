  // Interpreting div.ihx as an Intel formal HEX file.
  wire [7:0] buff [219:0];
  assign buff[0] = 8'h2;
  assign buff[1] = 8'h0;
  assign buff[2] = 8'h6;
  ...
  assign buff[136] = 8'h74;
  assign buff[137] = 8'ha;
  assign buff[138] = 8'h75;
  assign buff[139] = 8'hf0;
  assign buff[140] = 8'h3;
  assign buff[141] = 8'h84;
  assign buff[142] = 8'hf5;
  assign buff[143] = 8'h80;
  assign buff[144] = 8'h85;
  assign buff[145] = 8'hf0;
  assign buff[146] = 8'h90;
  assign buff[147] = 8'h74;
  assign buff[148] = 8'h14;
  assign buff[149] = 8'h75;
  assign buff[150] = 8'hf0;
  assign buff[151] = 8'h3;
  assign buff[152] = 8'h84;
  assign buff[153] = 8'hf5;
  assign buff[154] = 8'h80;
  assign buff[155] = 8'h85;
  assign buff[156] = 8'hf0;
  assign buff[157] = 8'h90;
  assign buff[158] = 8'h74;
  assign buff[159] = 8'h1;
  assign buff[160] = 8'h75;
  assign buff[161] = 8'hf0;
  assign buff[162] = 8'h10;
  assign buff[163] = 8'h84;
  assign buff[164] = 8'hf5;
  assign buff[165] = 8'h80;
  assign buff[166] = 8'h85;
  assign buff[167] = 8'hf0;
  assign buff[168] = 8'h90;
  assign buff[169] = 8'h74;
  assign buff[170] = 8'h80;
  assign buff[171] = 8'h75;
  assign buff[172] = 8'hf0;
  assign buff[173] = 8'h81;
  assign buff[174] = 8'h84;
  assign buff[175] = 8'h85;
  assign buff[176] = 8'hf0;
  assign buff[177] = 8'h90;
  assign buff[178] = 8'hf5;
  assign buff[179] = 8'h80;
  assign buff[180] = 8'h74;
  assign buff[181] = 8'h90;
  assign buff[182] = 8'h75;
  assign buff[183] = 8'hf0;
  assign buff[184] = 8'h80;
  assign buff[185] = 8'h84;
  assign buff[186] = 8'h85;
  assign buff[187] = 8'hf0;
  assign buff[188] = 8'h90;
  assign buff[189] = 8'hf5;
  assign buff[190] = 8'h80;
  assign buff[191] = 8'h74;
  assign buff[192] = 8'h90;
  assign buff[193] = 8'h75;
  assign buff[194] = 8'hf0;
  assign buff[195] = 8'h0;
  assign buff[196] = 8'h84;
  assign buff[197] = 8'h85;
  assign buff[198] = 8'hf0;
  assign buff[199] = 8'h90;
  assign buff[200] = 8'hf5;
  assign buff[201] = 8'h80;
  assign buff[202] = 8'h74;
  assign buff[203] = 8'h3;
  assign buff[204] = 8'h75;
  assign buff[205] = 8'hf0;
  assign buff[206] = 8'h0;
  assign buff[207] = 8'h84;
  assign buff[208] = 8'h85;
  assign buff[209] = 8'hf0;
  assign buff[210] = 8'h90;
  assign buff[211] = 8'hf5;
  assign buff[212] = 8'h80;
  assign buff[213] = 8'h2;
  assign buff[214] = 8'h0;
  assign buff[215] = 8'h62;
  assign buff[216] = 8'h75;
  assign buff[217] = 8'h82;
  assign buff[218] = 8'h0;
  assign buff[219] = 8'h22;
  wire [15:0] addr0 = addr;
  wire [15:0] addr1 = addr+1;
  wire [15:0] addr2 = addr+2;
  wire [15:0] addr3 = addr+3;
  wire [7:0] data_o0 = (addr0 < 220) ? buff[addr0] : 8'hx;
  wire [7:0] data_o1 = (addr1 < 220) ? buff[addr1] : 8'hx;
  wire [7:0] data_o2 = (addr2 < 220) ? buff[addr2] : 8'hx;
  wire [7:0] data_o3 = (addr3 < 220) ? buff[addr3] : 8'hx;
