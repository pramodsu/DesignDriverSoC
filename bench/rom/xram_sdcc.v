  // Interpreting xram_sdcc.hex as an Intel formal HEX file.
  wire [7:0] buff [203:0];
  assign buff[0] = 8'h2;
  assign buff[1] = 8'h0;
  assign buff[2] = 8'h6;
  ...
  assign buff[142] = 8'h7e;
  assign buff[143] = 8'h1;
  assign buff[144] = 8'h7f;
  assign buff[145] = 8'h0;
  assign buff[146] = 8'hee;
  assign buff[147] = 8'h24;
  assign buff[148] = 8'h0;
  assign buff[149] = 8'hfc;
  assign buff[150] = 8'hef;
  assign buff[151] = 8'h34;
  assign buff[152] = 8'h0;
  assign buff[153] = 8'hfd;
  assign buff[154] = 8'hee;
  assign buff[155] = 8'h24;
  assign buff[156] = 8'hff;
  assign buff[157] = 8'hfa;
  assign buff[158] = 8'hef;
  assign buff[159] = 8'h34;
  assign buff[160] = 8'hff;
  assign buff[161] = 8'hfb;
  assign buff[162] = 8'hea;
  assign buff[163] = 8'h24;
  assign buff[164] = 8'h0;
  assign buff[165] = 8'hf5;
  assign buff[166] = 8'h82;
  assign buff[167] = 8'heb;
  assign buff[168] = 8'h34;
  assign buff[169] = 8'h0;
  assign buff[170] = 8'hf5;
  assign buff[171] = 8'h83;
  assign buff[172] = 8'he0;
  assign buff[173] = 8'hfb;
  assign buff[174] = 8'hb;
  assign buff[175] = 8'h8c;
  assign buff[176] = 8'h82;
  assign buff[177] = 8'h8d;
  assign buff[178] = 8'h83;
  assign buff[179] = 8'heb;
  ...
  assign buff[187] = 8'hf8;
  assign buff[188] = 8'h2f;
  assign buff[189] = 8'h50;
  assign buff[190] = 8'hd3;
  assign buff[191] = 8'h90;
  assign buff[192] = 8'h7;
  assign buff[193] = 8'hff;
  assign buff[194] = 8'he0;
  assign buff[195] = 8'hf5;
  assign buff[196] = 8'h80;
  assign buff[197] = 8'h2;
  assign buff[198] = 8'h0;
  assign buff[199] = 8'h62;
  assign buff[200] = 8'h75;
  assign buff[201] = 8'h82;
  assign buff[202] = 8'h0;
  assign buff[203] = 8'h22;
  wire [15:0] addr0 = addr;
  wire [15:0] addr1 = addr+1;
  wire [15:0] addr2 = addr+2;
  wire [15:0] addr3 = addr+3;
  wire [7:0] data_o0 = (addr0 < 204) ? buff[addr0] : 8'hx;
  wire [7:0] data_o1 = (addr1 < 204) ? buff[addr1] : 8'hx;
  wire [7:0] data_o2 = (addr2 < 204) ? buff[addr2] : 8'hx;
  wire [7:0] data_o3 = (addr3 < 204) ? buff[addr3] : 8'hx;
