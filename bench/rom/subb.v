  // Interpreting subb.ihx as an Intel formal HEX file.
  wire [7:0] buff [162:0];
  assign buff[0] = 8'h2;
  assign buff[1] = 8'h0;
  assign buff[2] = 8'h6;
  ...
  assign buff[137] = 8'h9;
  assign buff[138] = 8'h75;
  assign buff[139] = 8'hf0;
  assign buff[140] = 8'h3;
  assign buff[141] = 8'hc3;
  assign buff[142] = 8'h95;
  assign buff[143] = 8'hf0;
  assign buff[144] = 8'hf5;
  assign buff[145] = 8'h80;
  assign buff[146] = 8'h74;
  assign buff[147] = 8'h9;
  assign buff[148] = 8'h75;
  assign buff[149] = 8'hf0;
  assign buff[150] = 8'h3;
  assign buff[151] = 8'hd3;
  assign buff[152] = 8'h95;
  assign buff[153] = 8'hf0;
  assign buff[154] = 8'hf5;
  assign buff[155] = 8'h80;
  ...
  wire [7:0] data_o0 = (addr0 < 163) ? buff[addr0] : 8'hx;
  wire [7:0] data_o1 = (addr1 < 163) ? buff[addr1] : 8'hx;
  wire [7:0] data_o2 = (addr2 < 163) ? buff[addr2] : 8'hx;
  wire [7:0] data_o3 = (addr3 < 163) ? buff[addr3] : 8'hx;
